...
//    }
   ...
   fun loadPost3978() {
       ...
       with(post) {
           postNum = 3978
           lineNum = 3
           imageUri = "https://cdn.pixabay.com/photo/2016/11/19/13/08/business-1839191_960_720.jpg"
           postText = arrayListOf(
    ...
    fun loadPost3979() {
        ...
        with(post) {
            ...
            postTransparency =10
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#E2B143"
            val textColor = "#4A171E"
            postFontFamily = 103
            postBackground = util.improveColorString(backgroundColor)
            val textcolo = util.improveColorString(textColor)
            val col = "#$textcolo"
    ...
    fun loadPost3984() {
       ...
       fun loadPost3985() {
        ...
        with(post) {
            postNum = 3985
            lineNum = 3
            imageUri = "https://cdn.pixabay.com/photo/2019/04/29/21/52/cake-4167209_960_720.jpg"
            postText = arrayListOf(
                " האדם המושלם ",
    ...
    fun loadPost3989() {
        ...
        with(post) {
            postNum = 3989
            lineNum = 3
            imageUri = "https://cdn.pixabay.com/photo/2017/03/08/19/08/zanzibar-2127575_960_720.jpg"
            postText = arrayListOf(
                " להיות חופשי  ",
                " זה להחליט בצורה חופשית ",
                " למי ולמה תהיה עבד. ",
            )
            textLocation = arrayListOf(10,-1, 32,5,0,0,0, 0)
            postId = 85
...
fun loadPost3990() {
    ...
    with(post) {
        postNum = 3990
        lineNum = 3
        imageUri = "https://cdn.pixabay.com/photo/2015/05/31/10/55/man-791049_960_720.jpg"
        postText = arrayListOf(
    ...
    fun loadPost3994() {
        ...
        with(post) {
            ...
            textLocation = arrayListOf(10,-1, 30,0,1,30,0, 0)
            postId = 85
            postTransparency =10
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#0A174E"
...
fun loadPost3998() {  //v
    ...
    with(post) {
        ...
        postText = arrayListOf(
            "  אין יופי בעולם בשבילך  ",
            " מלבד אותם מקומות ספורים ",
            " שאתה מוצא בהם יופי. ",
        )
        textLocation = arrayListOf(10,-1, 30,10,0,0,0, 0)
        postId = 85
...
//    -------------------------------------------------------------------------
    ...
    fun loadPost3999001() {  //v
        ...
        with(post) {
            ...
            textLocation = arrayListOf(10,-1,30,10,0,28,0, 0)
            postId = 85
            postTransparency =10
            postTextSize = arrayListOf(0, 16)
            val backgroundColor = "#0A174E"
      ...
      fun loadPost3999002() {  //v
        ...
        with(post) {
            ...
            postPadding = arrayListOf(10,0, 10, 0)
            lineSpacing=1.2f
            videoUrl="uHjsbA8Jv6A"
            videoText = util1.getPostExplanation(postNum, postText)
        }
        drawPost.drawPostFire(post, layout)
        util.sendPostToStringFirestore(post)
    }
      fun loadPost3999003() {  //v
        val post = Post()
        with(post) {
            postNum = 3999003
            lineNum = 3
            ...
            textLocation = arrayListOf(10,-1,33,10,1,26,0, 0)
            postId = 85
            postTransparency =10
            postTextSize = arrayListOf(0, 16)
            val backgroundColor = "#0A174E"
