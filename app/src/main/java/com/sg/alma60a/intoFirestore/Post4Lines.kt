...
fun loadPost4993() {
    ...
    fun loadPost4999023() {  //I  אזנבור להמאמא
        val post = Post()
        with(post) {
            postNum = 4999023
            lineNum = 4
            ...
            val col = "#$textcolo"
            postTextColor = arrayListOf(CONSTANT, col)
           videoUrl="ADYDZMc1GbU"
        }
        drawPost.drawPostFire(post, layout)
        util.sendPostToStringFirestore(post)
    }

    fun loadPost4999024() {  //I באאז דונה דונה
        val post = Post()
        with(post) {
            postNum = 4999024
            lineNum = 4
    ...
    fun loadPost4999025() {  //I  אמסטרונג
        val post = Post()
        with(post) {
            postNum = 4999025
            lineNum = 4
            ...
            postId = 87
            textLocation = arrayListOf(10,-1,23,20, 0, 0, 0, 0)
            postPadding = arrayListOf(10, 0, 10, 0)
            postTransparency =0
            postTextSize = arrayListOf(0, 12)
            val backgroundColor = "#000000"
    ...
    fun loadPost4999026() {  //I  את חרותי חווה א.
        val post = Post()
        with(post) {
            postNum = 4999026
            lineNum = 4
    ...
    fun loadPost4999027() {  //I        url="cIrGQD84F1g"   // תודה לחיים סוסא -
        val post = Post()
        with(post) {
            postNum = 4999027
            lineNum = 4
