...
//        util.sendPostToStringFirestore(post)
    ...
    fun loadPost449() {
        ...
        with(post) {
            postNum = 449
            lineNum = 4
            imageUri = "https://cdn.pixabay.com/photo/2022/11/07/18/29/bird-7576994_960_720.jpg"
            postText = arrayListOf(
                "  אין חדש תחת השמש ",
                " וטוב שכך ",
                " בגלל שגם עם הישן  ",
...
//        util.sendPostToStringFirestore(post)
    ...
    fun loadPost4943() { //I
        ...
        with(post) {
            ...
            lineNum = 4
            imageUri =
                "https://cdn.pixabay.com/photo/2018/09/14/22/51/cobblestones-3678292_960_720.jpg"
            postText = arrayListOf(
...
//        util.sendPostToStringFirestore(post)
    ...
    fun loadPost4965() {
        ...
        with(post) {
            ...
            lineNum = 4
            imageUri =
                "https://cdn.pixabay.com/photo/2018/05/24/18/18/hohenstaufen-3427266_1280.jpg"
            postText = arrayListOf(
                " המשיח כבר כאן ",
                " אבל משום מה  ",
                " רוב האנשים  ",
    ...
    fun loadPost4979() {
        ...
        with(post) {
            ...
            lineNum = 4
            imageUri =
                "https://cdn.pixabay.com/photo/2014/09/19/19/55/vernier-caliper-452987_1280.jpg"
            postText = arrayListOf(
                "השאיפה לדיוק",
                " יכולה להיות מכשול ",
                " זאם אתה צריך ",
    ...
    fun loadPost4999058() {   //v
        ...
        with(post) {
            ...
            postTransparency =10
            postTextSize = arrayListOf(0, 16)
            val backgroundColor = "#B1624E"
            val textColor = "#5CC8D7"
            postFontFamily = 103
            postBackground = util.improveColorString(backgroundColor)
            val textcolo = util.improveColorString(textColor)
            val col = "#$textcolo"
...
//            videoText = util1.getPostExplanation(postNum, postText)
    ...
    fun loadPost4999070() {
        ...
        with(post) {
            ...
            postText = arrayListOf(
                " דמוקרטיה זה ",
                " שלכל אחד יש את הזכות השווה ",
                "  להיות מטומטם,  ",
                " גם להכי חכמים שביננו. "
            )
            postId = 87
            textLocation = arrayListOf(10,-1, 33,10,0,0, 0, 0)
            postPadding = arrayListOf(10, 0, 10, 5)
