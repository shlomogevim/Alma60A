...
//        pref.edit().putString(SHARPREF_MOVING_BACKGROUND, FALSE).apply()
    ...
    fun loadPost581() {  //I
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,-1, 30,200,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =10
            postTextSize = arrayListOf(0, 14)
    ...
    fun loadPost582() {
        ...
        with(post) {
            ...
            postTransparency =10
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#FBEAEB"
            val textColor = "#2E3C7E"
            postFontFamily = 103
            postBackground = util.improveColorString(backgroundColor)
            val textcolo = util.improveColorString(textColor)
            val col = "#$textcolo"
    ...
    fun loadPost583() {  //I
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,-1, 28,90,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =8
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#000000"
    ...
    fun loadPost585() {  //I
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,-1, 28,60,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =5
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#000000"
    ...
    fun loadPost586() {  //I
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,20, 28,-1,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =0
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#000000"
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,40, 28,-1,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =0
            postTextSize = arrayListOf(0, 14)
            val backgroundColor = "#000000"
    ...
    fun loadPost588() {  //I
        ...
        with(post) {
            ...
            postId = 78
            textLocation = arrayListOf(10,80, 24,-1,0, 0,0, 0)
            postPadding = arrayListOf(0, 0, 0,0)
            postTransparency =7
            postTextSize = arrayListOf(0, 13)
            val backgroundColor = "#000000"
